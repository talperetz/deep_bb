...
DEFAULT_N_SENTENCES = 15
DEFAULT_N_WORDS = 15

# thresholds
MAX_TWEET_LENGTH = 140
SIMILARITY_THRESHOLD = 0.651
CHATTER_CONFIDENCE_THRESHOLD = 0.7
PREV_SENTENCE_MAX_SIMILARITY_THRESHOLD = 0.9
PAST_SENTENCES_MAX_SIMILARITY_THRESHOLD = 0.94
PREV_SENTENCE_MIN_SIMILARITY_THRESHOLD = 0.7
